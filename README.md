...
Signed: `<Filipe Cruz>`, `<student name>`, `<student name>`, `<student name>`  
Date: `<23-02-2026>`

## Authors and acknowledgment

LCOM Project for group GRUPO_2LEIC<0><3>_<3>.
Group members:
Filipe Carvalho Cruz, Pedro Fernandes Postiga, Pedro Gonçalves Vilaça.
